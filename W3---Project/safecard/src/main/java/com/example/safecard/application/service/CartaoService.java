...
public class CartaoService {
    ...
    public Cartao bloqueioTemporario(String numeroCartao, String cpf, CartaoMotivoBloqueio bloqueioMotivo) {
    ...
    public Cartao cadastro_redifinica_senha(String senha,String cpf,String numeroCartao) {
        Usuario usuario = usuarioRepository.findByCpf(cpf);
        Cartao cartao = cartaoRepository.findByNumeroCartao(numeroCartao);
    ...
    public void aumento_limite(String justificativa,double valor,String cpf,String numeroCartao){
        Usuario usuario = usuarioRepository.findByCpf(cpf);
        Cartao cartao = cartaoRepository.findByNumeroCartao(numeroCartao);
